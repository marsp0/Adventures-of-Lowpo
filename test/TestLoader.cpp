...
TEST_CASE("Visual Scene Skeleton Parsing")
{
    ...
    REQUIRE( glm::determinant(skeleton->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(torso->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(chest->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(neck->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(head->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(headEnd->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(upperArmL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(lowerArmL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(handL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(handLEnd->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(upperArmR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(lowerArmR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(handR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(handREnd->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(upperLegL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(lowerLegL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    matrixString = "-0.999156 0.04105425 -0.001460831 0 0.04052997 0.9793482 -0.1980774 1.282774 -0.006701252 -0.1979695 -0.9801853 -2.98023e-8 0 0 0 1";
    REQUIRE( glm::determinant(lowerFootL->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON );
    ...
    REQUIRE( glm::determinant(lowerFootLEnd->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(upperLegR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(lowerLegR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
    ...
    REQUIRE( glm::determinant(footR->matrix) - glm::determinant(glm::transpose(glm::make_mat4(Loader::SplitStringFloat(matrixString).data()))) < EPSILON);
